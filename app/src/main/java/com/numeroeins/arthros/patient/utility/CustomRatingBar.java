...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.filled_star;
    private int mStarOffResource = R.drawable.empty_star;
    private int mStarHalfResource = R.drawable.halffilled_star;
    ...
    private void initializeAttributes(AttributeSet attrs, Context context) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.CustomRatingBar_maxStars)
                ...
                mCurrentScore = a.getFloat(attr, 0f);
