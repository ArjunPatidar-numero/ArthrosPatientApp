...
import com.numeroeins.arthros.patient.databinding.DoctorRatingReviewAdapterBinding
...
class DoctorRatingReviewAdapter(activity: Context, orderList: ArrayList<String>)
    : RecyclerView.Adapter<DoctorRatingReviewAdapter.ListViewHolder>() {
    ...
    class ListViewHolder(listBinding: DoctorRatingReviewAdapterBinding) : RecyclerView.ViewHolder(listBinding.root)
    {
        var listBinding: DoctorRatingReviewAdapterBinding
        init {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val listBinding = DataBindingUtil.inflate<DoctorRatingReviewAdapterBinding>(
                LayoutInflater.from(parent.context)
                , R.layout.doctor_rating_review_adapter, parent, false)
